        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center py-16">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Dịch vụ xét nghiệm huyết thống, quan hệ cha con với độ chính xác
              cao và thời gian xử lý nhanh chóng
            </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">
                Kết quả chính xác{" "}
                <strong className="text-red-600">99.99%</strong> với công nghệ
                xét nghiệm tiên tiến, đáp ứng tiêu chuẩn quốc tế
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">
                Nhận kết quả trong vòng{" "}
                <strong className="text-red-600">5-7 ngày</strong> làm việc với
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">
                ...
                <strong className="text-red-600">mã hóa</strong> và bảo mật theo
                tiêu chuẩn cao nhất
              </p>
            </div>
          </div>
